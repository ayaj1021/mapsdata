...
class BuyDataCardRepository {
  BuyDataCardRepository(this._restClient);
  final RestClient _restClient;

  Future<BaseResponse<BuyDataCardResponse>> buyDataCard(
...
final buyDataCardRepositoryProvider = Provider<BuyDataCardRepository>(
  (ref) => BuyDataCardRepository(
