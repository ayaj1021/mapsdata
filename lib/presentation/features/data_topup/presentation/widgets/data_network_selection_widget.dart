...
class DataNetworkSelection extends StatefulWidget {
  ...
  @override
  State<DataNetworkSelection> createState() => _DataNetworkSelectionState();
}

class _DataNetworkSelectionState extends State<DataNetworkSelection> {
  @override
