...
class CablePlanWidget extends StatefulWidget {
  CablePlanWidget(
      {super.key,
  ...
  @override
  State<CablePlanWidget> createState() => _CablePlanWidgetState();
}

class _CablePlanWidgetState extends State<CablePlanWidget> {
  @override
