...
class ValidateCardNumberRepository {
  ValidateCardNumberRepository(this._restClient);
  final RestClient _restClient;

  Future<BaseResponse<ValidateCardNumberResponse>> validateCardNumber(
      ValidateCardNumberRequest request) async {
    try {
      final res = await _restClient.validateCardNumber(request);
...
final validateCardNumberRepositoryProvider =
    Provider<ValidateCardNumberRepository>(
  (ref) => ValidateCardNumberRepository(
