...
//   static Future<bool> canDoBiometrics() async {
...
class Biometrics {
  ...
  static Future<bool> canDoBiometrics() async {
    final localAuth =
        LocalAuthentication(); // Create instance within static method
    final canDoBiometrics = await localAuth.canCheckBiometrics;
